...
const Navbar = () => {
    ...
    return (
        <div>
            <div className="flex lg:space-x-44  lg:pl-12 items-center lg:h-20 h-14 space-x-3">
                ...
                <NavLink to="signin">
                    <div className="text-white text-sm">
                        <p className="lg:text-lg text-xs ">Sign in</p>
                        <p className="font-semibold">Account & Lists</p>
                    </div>
                </NavLink>
                <NavLink to="login">
                    <div className="text-white text-sm">
                        <p className="lg:text-lg text-xs">Returns</p>
                        <p className="font-semibold">& Orders</p>
                    </div>
                </NavLink>
                <div className="flex items-center font-medium text-slate-100 mr-5 space-x-6">
                    <NavLink to="/"><TiHomeOutline className="h-7 w-7" /></NavLink>
                    <div className="relative">
                        <NavLink to="/cart">
                            <FaShoppingCart className="lg:text-2xl text-lg" />
